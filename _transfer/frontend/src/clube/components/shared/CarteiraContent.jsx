/**
 * CarteiraContent.jsx — Shared portfolio content for both ClubeCarteiraPage and GestorCarteiraTab.
 *
 * Renders: compliance banner, position table with live prices, CSV import form.
 * Data-fetching (price fetch) is self-contained. Receives clube/posicoes as props.
 */
...
export default function CarteiraContent({ clube, posicoes: initialPosicoes, getToken, user, onPosicoesFetched }) {
                ...
                <button
                  ...
                  onClick={async () => {
                    ...
                    try {
                      ...
                      onPosicoesFetched?.(updatedPositions);
