-- ============================================================
-- TRANSFER NOTE
-- Source: server/migrations/006b_retroactive_schema_dashboard_tables.sql
-- Classification: CLUBE-ONLY (9 tables) + GMT-ONLY (market_snapshot)
-- Clube tables: estatuto_versoes, movimentacoes, ledger_entries,
--   cotas_tranches, cotistas_historico, clube_roles,
--   documentos_gerados, audit_log, eventos_corporativos (DEAD)
-- GMT table: market_snapshot (do NOT migrate — GMT-only)
-- ============================================================
