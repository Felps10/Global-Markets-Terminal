-- ============================================================
-- TRANSFER NOTE
-- Source: server/migrations/006_rls_hardening.sql
-- Classification: SHARED — touches both GMT and Clube tables
-- GMT-specific sections marked -- [GMT] below.
-- Clube-specific sections marked -- [CLUBE] below.
-- ============================================================
...
-- [CLUBE] eventos_corporativos — DEAD TABLE, drop in new app
