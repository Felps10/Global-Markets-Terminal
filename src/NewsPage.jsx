...
const ASSETS = {
  ...
  BNTX: { name: "BioNTech", cat: "biotech", exchange: "NASDAQ" },
  REGN: { name: "Regeneron", cat: "biotech", exchange: "NASDAQ" },
  VRTX: { name: "Vertex Pharma", cat: "biotech", exchange: "NASDAQ" },
  GILD: { name: "Gilead Sciences", cat: "biotech", exchange: "NASDAQ" },
  CAT: { name: "Caterpillar", cat: "industrials", exchange: "NYSE" },
  DE: { name: "Deere & Company", cat: "industrials", exchange: "NYSE" },
  HON: { name: "Honeywell", cat: "industrials", exchange: "NASDAQ" },
  GE: { name: "GE Aerospace", cat: "industrials", exchange: "NYSE" },
  UPS: { name: "UPS", cat: "industrials", exchange: "NYSE" },
...
const CATEGORIES = {
  ...
  biotech:        { label: "Biotech",              icon: "🧬",  color: "#EC407A" },
  ...
  industrials:    { label: "Industrials",          icon: "🏭",  color: "#78909C" },
