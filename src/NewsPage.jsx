...
const ASSETS = {
  ...
  AMZN: { name: "Amazon", cat: "tech", exchange: "NASDAQ" },
  NVDA: { name: "NVIDIA", cat: "tech", exchange: "NASDAQ" },
  META: { name: "Meta Platforms", cat: "tech", exchange: "NASDAQ" },
  TSLA: { name: "Tesla", cat: "tech", exchange: "NASDAQ" },
  ...
  PETR4: { name: "Petrobras PN", cat: "brasil", exchange: "B3" },
  VALE3: { name: "Vale", cat: "brasil", exchange: "B3" },
  ITUB4: { name: "Itaú Unibanco", cat: "brasil", exchange: "B3" },
  BBDC4: { name: "Bradesco", cat: "brasil", exchange: "B3" },
  BBAS3: { name: "Banco do Brasil", cat: "brasil", exchange: "B3" },
};
...
const CAT_SOURCE_AFFINITY = {
  ...
  energy:     ["reuters", "bloomberg", "wsj", "ft", "morningstar"],
...
const MOCK_SOURCES_BY_CAT = {
  ...
  energy: ["Reuters", "Bloomberg", "FT", "WSJ", "Morningstar"],
