/**
 * OperacionalContent.jsx — Shared operations queue for both ClubeOperacionalPage and GestorFilaOperacoesTab.
 *
 * Renders: loading/error states, operations queue table with status badges and action buttons.
 * Self-contained data-fetching via fetchOperacional.
 */
...
export default function OperacionalContent({ clube, getToken, user }) {
